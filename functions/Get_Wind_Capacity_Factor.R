...
get_wind_CF <- function(WS){
  ...
  ifelse(WS <= 3, 0, 
         ifelse(WS < 12.5 & WS > 3, (634.228 - 1248.5*WS + 999.57*WS^2 - 426.224*WS^3 + 105.617*WS^4 - 15.4587*WS^5 + 1.3223*WS^6 - 0.0609186*WS^7 + 0.00116265*WS^8)/2000,
                ifelse(WS < 25 & WS >= 12.5, 1, 0)))
